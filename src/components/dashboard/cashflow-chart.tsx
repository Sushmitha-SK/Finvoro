...
export function CashflowChart({ data }: { data: CashflowPoint[] }) {
    ...
    return (
        <Card className="h-full">
            ...
            <CardContent>
                <div className="h-64 w-full" role="img" aria-label="Area chart of monthly income and expenses">
                    <ResponsiveContainer width="100%" height="100%">
                        <AreaChart data={data} margin={{ top: 8, right: 8, left: 0, bottom: 0 }}>
                            ...
                            <Area type="monotone" dataKey="income" name="Income" stroke="#10b981" strokeWidth={2} fill="url(#fillIncome)" />
                            <Area type="monotone" dataKey="expenses" name="Expenses" stroke="#f43f5e" strokeWidth={2} fill="url(#fillExpenses)" />
                        </AreaChart>
                    </ResponsiveContainer>
                </div>
            </CardContent>
