...
import { transactions } from "@/config/landing-content";
...
const scrollTransform = {
    from: { opacity: 1, scale: 0.8, rotateX: 20, x: 0, y: -80 },
    to: { opacity: 1, scale: 1, rotateX: 0, x: 0, y: 0 },
    transition: {
        ...
        >
            ...
            >
                ...
                <div className="relative overflow-hidden rounded-2xl border border-border bg-card shadow-2xl shadow-black/10">
                    ...
                    <div className="grid min-h-125 grid-cols-1 md:grid-cols-[180px_1fr]">
